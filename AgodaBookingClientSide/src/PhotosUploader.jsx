...
export default function PhotosUploader({addedPhotos,onChange}) {
  ...
  return (
    <>
     ...
     <div className="gap-2 mt-2 grid grid-cols-3 lg:grid-cols-6 md:grid-col-4 ">
       ...
       <label className="h-32 border bg-transparent rounded-2xl p-2 items-center text-3xl text-gray-600 flex justify-center gap-2 cursor-pointer">
